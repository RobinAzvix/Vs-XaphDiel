...
class CreditsState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var defaultList:Array<Array<String>> = [ //Name - Icon name - Description - Link - BG Color
			...
			['Trecker',				'trecker',			"TIREN PAROOOO!!!",					 			 			 'https://www.youtube.com/@Treckeruwu',							'FFFFFF'],
			['Oceana',				'osana',			"No se que poner",					 						 'https://www.youtube.com/@XaphDiel',							'FFFFFF'],
			['Yaar',				'yaar',				"No se que poner",					 			 			 'https://www.youtube.com/@Treckeruwu',							'FFFFFF'],
			['El012',				'012',				"No se que poner",					 						 'https://www.youtube.com/@XaphDiel',							'FFFFFF'],
			['DipluMatrix',			'kawaisprite',		"El Credor del sandwich de salchicha",					 	 'https://www.youtube.com/@Treckeruwu',							'FFFFFF']
		];
